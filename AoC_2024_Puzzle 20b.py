...
def adjust_graph_clean(points_graph, walls, wandh, wall_to_remove):
    
    points_graph.pop((wall_to_remove[0], wall_to_remove[1]))
    
    if (wall_to_remove[0] - 1, wall_to_remove[1]) in points_graph:
        points_graph[(wall_to_remove[0] - 1, wall_to_remove[1])].remove((wall_to_remove[0], wall_to_remove[1]))
    if (wall_to_remove[0] + 1, wall_to_remove[1]) in points_graph:
        points_graph[(wall_to_remove[0] + 1, wall_to_remove[1])].remove((wall_to_remove[0], wall_to_remove[1]))
    if (wall_to_remove[0], wall_to_remove[1] - 1) in points_graph:
        points_graph[(wall_to_remove[0], wall_to_remove[1] - 1)].remove((wall_to_remove[0], wall_to_remove[1]))
    if (wall_to_remove[0], wall_to_remove[1] + 1) in points_graph:
        points_graph[(wall_to_remove[0], wall_to_remove[1] + 1)].remove((wall_to_remove[0], wall_to_remove[1]))
